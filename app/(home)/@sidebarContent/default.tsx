...
const DMListHeaderText = styled.p`
    font-size: 14px;
    font-weight: 500;
    line-height: 18px;
`

const CreateDMIconContainer = styled.span`
    cursor: pointer;
    position: relative;
...
function CreateDMIcon() {
    ...
    return (
        <CreateDMIconContainer onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
            <FaPlus size={14} />
            <Tooltip
                position="top"
                show={hover}
    ...
    return (
        ...
        <Fragment>
            ...
            <Container>
                ...
                <DMListContainer>
                    <DMListHeader>
                        <DMListHeaderText>Direct Messages</DMListHeaderText>
                        <CreateDMIcon />
                    </DMListHeader>
                    <DMListWrapper>
